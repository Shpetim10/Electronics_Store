...
public class ProductInformationView extends VBox implements Design {
    ...
    private Label productIdField = new Label("");

    private Label quantity = createAlignedBlackLabel("");
    private Label quantityField = new Label();
...
//        pane.add(priceField, 2, 8);
        ...
        pane.add(brandLabel, 1, 10);
        pane.add(brandField, 2, 10);

        pane.add(sectorLabel, 1, 8);
        pane.add(sectorField, 2, 8);
    ...
    public Label getProductIdField() {
    ...
    public Label getSectorField() {
        return sectorField;
    }

    public Label getSupplierField() {
        return supplierField;
    }

    public Label getBrandField() {
        return brandField;
    }

    public Label getLastRestockPicker() {
        return lastRestockPicker;
    }

    public Label getSellingPriceField() {
        return sellingPriceField;
    }

    public Label getPriceBoughtField() {
        return priceBoughtField;
    }
