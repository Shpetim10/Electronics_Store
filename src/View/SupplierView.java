...
public class SupplierView extends GridPane implements Design {
    ...
    public void setUpView(){
        ...
        grid.setVgap(25);
        grid.setHgap(25);
        grid.add(createAlignedBlackBoldLabel("Id"), 0, 0);
        grid.add(sId, 1, 0);
        grid.add(createAlignedBlackBoldLabel("Name "), 2, 0);
        grid.add(cName, 3, 0);
        grid.add(createAlignedBlackBoldLabel("Email"), 4, 0);
        grid.add(Email, 5, 0);
        grid.add(createAlignedBlackBoldLabel("Phone Number"), 6, 0);
        grid.add(phone, 7, 0);
        grid.add(createAlignedBlackBoldLabel("Address"), 8, 0);
