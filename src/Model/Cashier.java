...
public class Cashier extends User implements InventoryManagement,Serializable{
    ...
    @Serial
    private static final long serialVersionUID = 6951695330726350233L;
    ...
    public Cashier(int id, String firstName, String lastName, String username, String password, String email, String phoneNumber, LocalDate dateEmployed, EmployeeRole role, double salary, ArrayList<Permission> permissions, boolean isActive) {
